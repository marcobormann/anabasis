...
public class Nikias extends Engine implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4703746537222290531L;
	/**constructor tells this engine for whom it plays*/
	public Nikias(int rating){super("Nikias", rating);}
    ...
    public String toCSV()
    {
        return getId()+";Nikias;"+Double.valueOf(getRating()).toString();
    }
